    ...
    public class UpYun
    {
        ...
        */
        ...
        private HttpWebResponse newWorker(string method, string Url, byte[] postData, Hashtable headers)
        {
            ...
            if (postData != null)
            {
                ...
                request.Headers.Add("x-gmkerl-quality", "100");
            }
        ...
        */
        ...
        public static string md5_stream(Stream stream)
        {
            ...
            try
            {
                //stream = new System.IO.FileStream(pathName, System.IO.FileMode.Open, System.IO.FileAccess.Read, System.IO.FileShare.ReadWrite);
