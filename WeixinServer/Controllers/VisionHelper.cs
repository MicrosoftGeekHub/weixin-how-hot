...
namespace WeixinServer.Controllers
{
    ...
    public class VisionHelper
    {
        ...
        public string AnalyzeImage(string imagePathOrUrl)
        {
            ...
            return this.RenderAnalysisResultAsImage(analysisResult, this.ShowRichAnalysisResult(analysisResult));
        }
        ...
        private string ShowRichAnalysisResult(AnalysisResult result)
        {
            ...
            if (result.Faces != null && result.Faces.Length > 0)
            {
                ...
                desStringWriter.Write(string.Format(", 画面火爆指数为{0:F0}。\n", ascr));//TODO 少量 or More by Score
